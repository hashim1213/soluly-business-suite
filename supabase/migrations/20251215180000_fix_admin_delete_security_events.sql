-- =============================================
-- Fix admin delete - add security_events cleanup
-- =============================================
...
BEGIN
  ...
  IF v_member_id IS NOT NULL THEN
    ...
    -- Delete member-specific data first
    DELETE FROM security_events WHERE team_member_id = v_member_id;
    ...
    IF v_org_member_count = 1 AND v_org_id IS NOT NULL THEN
      ...
      -- Delete security events for the org
      DELETE FROM security_events WHERE organization_id = v_org_id;
